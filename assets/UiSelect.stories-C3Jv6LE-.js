import{j as e}from"./jsx-runtime-C6qLVRqm.js";import{R as o}from"./index-C2WPW1L7.js";import{c as f}from"./index-BmPQVgn-.js";import{U as m,b as h,E as C}from"./UiTypography-Dl3m25sY.js";const j="_UiSelect_3uv47_1",R={UiSelect:j},c=({children:t,heading:a,subLabel:r,disabled:s,onChange:n,placeholder:d,postfixIcon:p,...i})=>{const[b,y]=o.useState(i.value||i.defaultValue||""),S=o.useCallback(u=>{y(u.target.value),n==null||n(u)},[n]);return e.jsxs("div",{children:[a?e.jsx(m,{size:h.MD,className:"mb-xxs",children:a}):null,e.jsxs("div",{className:f(R.UiSelect,"relative","rounded-xl","border","hover:border-secondary-alt-700",s?["pointer-events-none","border-secondary-alt-300","bg-secondary-alt-200"]:["border-secondary-alt-500","bg-white"]),children:[e.jsxs("select",{...i,className:`m-0
					w-full
					cursor-pointer
					appearance-none
					border-0
